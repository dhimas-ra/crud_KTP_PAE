...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String gender, String alamat, String agama, String status, String warganegara) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "Enterprise.crud.ktp.fix.Data[ id=" + id + " ]";
    }
