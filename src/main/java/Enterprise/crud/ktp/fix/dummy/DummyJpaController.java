 ...
 */
package Enterprise.crud.ktp.fix.dummy;

import Enterprise.crud.ktp.fix.dummy.exceptions.NonexistentEntityException;
import Enterprise.crud.ktp.fix.dummy.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("Enterprise_crud.ktp.fix_jar_0.0.1-SNAPSHOTPU");
